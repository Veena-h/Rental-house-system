    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="agents-grid.jsp" id="navbarDropdown" role="button" >Agents</a>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Latest Sold Property</h1>
              ...
              <div class="card-overlay">
                <div class="card-header-b">
                  ...
                  <div class="card-title-b">
                    <h2 class="title-2">
                      <a href="blog-single.html">Palace
                        <br> new</a>
                    </h2>
                  </div>
                  <div class="card-date">
                    <span class="date-b">12 Feb. 2024</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="card-box-b card-shadow news-box">
              ...
              <div class="card-overlay">
                <div class="card-header-b">
                  <div class="card-category-b">
                    <a href="blog-single.html" class="category-b">sold</a>
                  </div>
                  <div class="card-title-b">
                    <h2 class="title-2">
                      <a href="blog-single.html">Comfy
                        <br>homie</a>
                    </h2>
                  </div>
                  <div class="card-date">
                    <span class="date-b">1 Jan. 2024</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-box-b card-shadow news-box">
              ...
              <div class="card-overlay">
                <div class="card-header-b">
                  ...
                  <div class="card-title-b">
                    <h2 class="title-2">
                      <a href="blog-single.html">closed
                        <br> comfy</a>
                    </h2>
                  </div>
                  <div class="card-date">
                    <span class="date-b">28 Sep. 2023</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-box-b card-shadow news-box">
              ...
              <div class="card-overlay">
                <div class="card-header-b">
                  ...
                  <div class="card-title-b">
                    <h2 class="title-2">
                      <a href="blog-single.html">open
                        <br> door</a>
                    </h2>
                  </div>
                  <div class="card-date">
                    <span class="date-b">9 Aug. 2019</span>
                  </div>
                </div>
              </div>
            </div>
