    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="agents-grid.jsp" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Agents</a>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><%=s %></a>
            <div class="dropdown-menu">
          ...
          <div class="col-md-4">
            <div class="card-box-c foo">
              <div class="card-header-c d-flex">
                ...
                <div class="card-title-c align-self-center">
                  <h2 class="title-c">Best-property</h2>
                </div>
              </div>
              <!-- <div class="card-body-c">
                <p class="content-c">
     ...
     <%
             ...
             try{
                ...
                for(image e:al)
                {
                	...
                	if(e.getId()==19)
                	{  
                	 byte[] imagedata = e.getImage();
                	String base64Image =imagedata !=null ? Base64.getEncoder().encodeToString(imagedata): " "; 
                	//String base64Image = imagedata != null ? new String(Base64.getEncoder().encode(imagedata)) : "";
            ...
            <div class="carousel-item-b swiper-slide">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  ...
                  <img src="data:image/*;base64, <%=base64Image%>"  class="img-a img-fluid"> 
                </div>
                  ...
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="property-grid.jsp">206 Mount
                          <br /> Olive Road Two</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
                      ...
                      <a href="property-grid.jsp" class="link-a">Click here to view
                        <span class="bi bi-chevron-right"></span>
                      </a>
                    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              <div class="title-box">
                <h2 class="title-a">Latest Sold Property</h2>
              </div>
              <!-- <div class="title-link">
                ...
                <div class="card-overlay">
                  <div class="card-header-b">
                    ...
                    <div class="card-title-b">
                      <h2 class="title-2">
                        <a href="blog-single.html">House is sold
                          <br> </a>
                      </h2>
                    </div>
                    <div class="card-date">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="testimonials-content">
                      <p class="testimonial-text">
                       ...
                       Your hard work helped us find our dream home, and we couldn’t be more grateful or excited about this milestone.
                      </p>
                    </div>
