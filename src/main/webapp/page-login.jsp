...
<body class="h-100" style="background-image: linear-gradient(357deg, black, #726ebf);">
           ...
           try
          	{
          	 ...
          	 List<form_entity> al=f.select();
          	 
          	 for(form_entity e:al)
          	 {	 
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form action="admin_login" method="post" class="mt-5 mb-5 login-input">
                                    ...
                                    <button type="submit?id=<%=e.getId()%>" class="btn login-form__btn submit w-100">Sign In</button>
                                </form>
