                        ...
                        <li class="icons dropdown">
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                ...
                                %>
                                    <ul>
                                        <li>
                                            <a><i class="icon-user"></i> <span><%=name %></span></a>
                                        </li>  
                   ...
                   <!--  <li class="nav-label">Table</li> -->
                    ...
                    <!-- <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li>
                        <a href="href="app-profile1.jsp" aria-expanded="false">
                            <i class="icon-screen-tablet menu-icon"></i><span class="nav-text">Profile</span>
                        </a>
                       <!--  <ul aria-expanded="false">
                            <li><a href="./app-profile.html">Profile</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="card-profile__info">
                                    <li class="mb-1"><strong class="text-dark mr-4">Mobile</strong> <span><%=e.getPhone() %></span></li>
                                    <li><strong class="text-dark mr-4">Email</strong><%=e.getEmail() %> <span></span></li>
                                </ul>
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="card">
                            <div class="card-body">
                                <form action="admin_update"  method="post" class="form-profile">
                                ...
                                <div class="basic-form">
                                    ...
                                    <form action="admin_update" method="post">
                                        <!-- <div class="form-row">
                                            ...
                                            <input type="hidden" class="form-control" placeholder="Name"  name="id" value=<%=e.getId() %>>    
                                        ...
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" class="form-control" placeholder="Name" name="name" value=<%=e.getName() %>>
                                        </div>
                                        <div class="form-group">
                                            <label>Mobile-no</label>
                                            <input type="number" class="form-control" placeholder="phone no"  name="phone"  value=<%=e.getPhone() %> >
                                        </div>
                                        <div class="form-group ">
                                                <label>Email</label>
                                                <input type="email" class="form-control" placeholder="Email"   name="email"  value=<%=e.getEmail() %> >
                                           	 </div>
                                            <div class="form-group ">
                                                <label>Password</label>
                                                <input type="password" class="form-control" placeholder="Password"   name="password" value=<%=e.getPassword() %>>
                                            </div>
