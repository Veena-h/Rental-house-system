<%@page import="com.entity.book_form_entity"%>
                 ...
                 <!--    <div class="col-lg-6">
                  ...
                  <!--   <div class="col-lg-6">
                    ...
                    <div class="col-lg">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Agents-Details</h4>
                                <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <%
									           try
									          	{
									          	 form_model f=new form_model(form_conn.getconnection());
									          	 List<book_form_entity> al=f.book_show_admin();
									          	 
									          	 for(book_form_entity e:al)
									          	 {	 
                                            ...
                                            <tr>
                                                ...
                                                <td><%=e.getEmail() %></td>
                                                 <td><%=e.getPhone() %></td>
                                                  <td><%=e.getVisiting_date()%></td>
                                                   <td><%=e.getVisiting_time() %></td>
                                                    <td><%=e.getReason() %></td>
