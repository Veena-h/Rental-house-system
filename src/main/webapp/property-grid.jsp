    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="contact.jsp">FeebBack</a>
          </li>
        </ul>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            <div class="grid-option">
              ...
              <form action="psearch_servlet" method="get">
                <div class="form-outline" data-mdb-input-init>
				 <input type="search" id="name" name="name3" class="p-1" />
          ...
          <div class="col-md-4">
            <div class="card-box-a card-shadow">
              <div class="img-box-a">
                <img src="data:image/*;base64, <%=base64Image%>" alt="" class="img-a img-fluid  border border-primary ">
              </div>
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  <div class="card-header-a">
                    <h2 class="card-title-a">
                      <a href="#"><%=e.getProperty_Id() %>
                        <br /> <%=e.getProperty_name() %></a>
                    </h2>
                  </div>
                  ...
                  <div class="card-body-a">
                    ...
                    <a href="#" class=""><!-- Click here to view --><%=e.getLocation()%>
