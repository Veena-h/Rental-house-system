                    ...
                    <li>
                        <a  href="user_request.jsp" aria-expanded="false">
                            ...
                            <!-- start -->
                                ...
                                <!-- count -->
                               <!--  <span class="badge gradient-1 badge-pill badge-primary"  id="show_notification">0</span> -->
        ...
        <div class="content-body">
            ...
            <div class="container-fluid mt-3">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">Houses Sold</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">456</h2>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white">Rs.18541</h2>
                                    <p class="text-white mb-0">Jan - March 2019</p>
                                </div>
                ...
                <%
                  ...
                  String name11=(String)request.getSession().getAttribute("name");
                %>
                
                <p class="h1 ml-5 text-secondary">Welcome Back ! <span ><%=name11 %></span></p>
 ...
 -->
        ...
        ***********************************-->
        <div class="footer mt-5">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="https://themeforest.net/user/quixlab">CodeCrafters</a> 2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
